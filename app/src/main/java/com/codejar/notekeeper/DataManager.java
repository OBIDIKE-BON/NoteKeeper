...
import com.codejar.notekeeper.data.NoteKeeperContract;
...
//            ourInstance.initializeExampleNotes();
    ...
    public static void loadFromDb(NotekeeperOpenHelper helper){
...
//               getting noteInfo table data
        ...
        Cursor noteQuery = db.query(NoteInfoEntry.TABLE_NAME,NoteColumns,
                null,null,null,null,orderNoteBy);
        loadNoteFromDB(noteQuery);
    }

    private static void loadCourseFromDB(Cursor CourseCursor) {
    ...
    private static void loadNoteFromDB(Cursor NoteCursor) {
        if (NoteCursor!=null) {
            ...
            int noteIdPos = NoteCursor.getColumnIndex(NoteInfoEntry._ID);
            ...
            while (NoteCursor.moveToNext()) {
                ...
                int noteId = NoteCursor.getInt(noteIdPos);
                NoteInfo note = new NoteInfo(dm.getCourse(courseId),noteTitle,noteText,noteId);
                //add to the list of notes
                dm.mNotes.add(note);
            }
